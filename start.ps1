...
docker container create --name temp_v1 -v samplephpwebsite_site_v1:/site -v samplephpwebsite_conf_v1:/conf -v samplephpwebsite_bdd_install_v3:/bdd/install hello-world
